		...
		<div class="row contact_information">
			...
			<div class="col-lg-6 col-md-6">
				<div class="mt-5 information">
					...
					<p class="mb-3 text-capitalize">For General Queries, Including Partnership Opportunities, Please Email Us At <a href="eic@yahoo.com">cerebroeci@gmail.com</a></p>
				</div>
			</div>
			<div class="col-lg-6 col-md-6 mt-md-5 mt-2 information">
				...
				<p class="mb-3 text-capitalize">We Are Here To Help! If You Have Technical Issues, Contact Support  <span>+234 388 455 6789</span>.</p>
			</div>
		</div>
	</div>
</section>
